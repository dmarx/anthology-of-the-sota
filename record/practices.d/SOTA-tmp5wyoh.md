...
date: '2026-09-15'
source:
# LIT-tmpsizdi is primary: it states the requirement most sharply -- rank-4
...
# than the gradient.
- LIT-056
# LIT-tmpaqpkd is the negative case -- what happens when the compressor is put
...
# SOTA-tmp5wyoh: Pair any gradient compressor with error feedback, and correct the momentum it is applied under
...
Set the rank or ratio second. [LIT-tmpsizdi](../literature.d/LIT-tmpsizdi.md) reports rank 2 sufficient for
...
with Adam: [LIT-tmpaqpkd](../literature.d/LIT-tmpaqpkd.md) finds that applying error-compensated
...
<!-- inactive-ok-block: SOTA-tmpb5sfm — Proposed, and named here as the
     remedy for the one case this practice cannot cover -->
does not, the fix is to move the compressor, which is [SOTA-tmpb5sfm](SOTA-tmpb5sfm.md).
...
[LIT-tmpsizdi](../literature.d/LIT-tmpsizdi.md)'s own limitations say transformer language models may need
...
**Whether compression pays at all is a separate question.** [LIT-tmpl1w3e](../literature.d/LIT-tmpl1w3e.md)
