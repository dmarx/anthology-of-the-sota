...
- **v-prediction for video super-resolution.** The same group's video
  result agrees with SOTA-195: on one super-resolution stage, v-prediction
  ...
  this report and Progressive Distillation (LIT-067), the practice's source.
