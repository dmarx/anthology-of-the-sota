...
- version: 2
  ...
  note: >-
    ...
    subject, now filed as LIT-tmpq75ig and LIT-tmpsdcmd. The wrong sentence is
...
[LIT-tmpq75ig](LIT-tmpq75ig.md), and weight-space ensembling of a fine-tuned model with its own
initialization, now [LIT-tmpsdcmd](LIT-tmpsdcmd.md). Model soups, snapshot ensembles and Polyak
