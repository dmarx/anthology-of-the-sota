...
arxiv: '2603.15569'
# Mamba-3 is three changes to Mamba-2, from an inference-first view.
extends:
- LIT-162
first_author: 'Lahoti'
keywords:
...
# LIT-165: Mamba-3: Improved Sequence Modeling using State Space Principles
...
Mamba's selectivity ([LIT-161](LIT-161.md)) → the duality and Mamba-2 ([LIT-162](LIT-162.md)) →
