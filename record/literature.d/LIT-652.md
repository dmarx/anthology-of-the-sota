...
- version: 2
  date: '2026-09-24'
  note: >-
    NaViT, which this note said was not held, is now filed with a practice
    (SOTA-tmpao7ji). The Standing section points to both.
tags:
- generative-modeling
- vision-and-graphics
...
---
<!-- inactive-ok-file: SOTA-386, SOTA-389, SOTA-tmpao7ji — Proposed practices Sora adopts; named to say it adds adoption, not evidence -->


# LIT-652: Video generation models as world simulators
...
- **Native-size training over fixed crops** has no practice for
  generative models. Sora's square-crop comparison is qualitative. NaViT
  ([LIT-tmpofv7h](LIT-tmpofv7h.md)), its reference 18, is now filed. It supports
  [SOTA-tmpao7ji](../practices.d/SOTA-tmpao7ji.md), a measured practice for ViT pretraining, which isolates
  aspect ratio only in a probe.
