...
- version: 2
  ...
  note: >-
    ...
    full report (NOTE-361) keeps MTP only as a training objective and
...
adopter says it drafts with the head: DeepSeek-V4's full report ([NOTE-361](../notes.d/NOTE-361.md))
