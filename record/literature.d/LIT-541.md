...
summary: >-
  ...
  model, not how sharply the loss rises in them. Read as [NOTE-286](../notes.d/NOTE-286.md).
---

# LIT-541: Deep Learning is Singular, and That's Good

Murfet, Wei, Gong, Li, Gell-Redman and Quella (2020) — [ARXIV-2010.11560](https://arxiv.org/abs/2010.11560).
Read as [NOTE-286](../notes.d/NOTE-286.md).
