...
<!-- inactive-ok-file: ADR-024 — Superseded by ADR-049. This decision took one of
     the options it listed and declined to choose between, so it is cited as the question
     being answered rather than as doctrine -->
