...
making it specialise. Its predecessors are here too — [LIT-188](LIT-188.md),
[LIT-187](LIT-187.md), [LIT-189](LIT-189.md) — so the GShard this paper
...
[SOTA-150](../practices.d/SOTA-150.md): being upstream is the
reason to state it once rather than leave it as everything's unexamined
premise. This paper sources the design half
([SOTA-149](../practices.d/SOTA-149.md)); the sparsity claim itself
is sourced where it belongs, to [LIT-188](LIT-188.md).
