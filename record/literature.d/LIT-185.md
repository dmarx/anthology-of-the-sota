...
**The thing it accelerates is now filed.** [SOTA-tmp6mgiw](../practices.d/SOTA-tmp6mgiw.md) is speculative
decoding itself, from [LIT-tmptlzmx](LIT-tmptlzmx.md) and [LIT-tmphbbt7](LIT-tmphbbt7.md); this paper is a method
...
**Audited by [#121](https://github.com/dmarx/anthology-of-the-sota/issues/121); unsourced and unread.** No reading note exists,
so nothing has assessed it. Recorded because `inference-optimization` is a topic
the record does file practices under — seven of them — so this is a candidate
the audit could not evaluate rather than one it declined.
