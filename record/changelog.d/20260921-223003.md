...
- **`LIT-tmpzi9vi`** — *mHC-lite: You Don't Need 20 Sinkhorn-Knopp
  Iterations* (Yang, 2026), read as `NOTE-tmpa0q97`.

### Changed

- **`SOTA-136`** → v3. Gains `LIT-tmpzi9vi` as a source and one instruction:
