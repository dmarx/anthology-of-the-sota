...
---
# NOTE-tmp71f2s: ZeRO: Memory Optimizations Toward Training Trillion Parameter Models
...
- ZeRO-Infinity: Breaking the GPU Memory Wall for Extreme Scale Deep
  Learning ([LIT-tmpycca1](../literature.d/LIT-tmpycca1.md)) — Extends ZeRO-3 with heterogeneous NVMe/CPU
