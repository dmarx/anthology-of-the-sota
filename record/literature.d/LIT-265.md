...
<!-- inactive-ok-file: THEORY-tmpih985 — Proposed, and named in the standing
     section as what reads this paper together with LIT-058, which is where a
     Proposed account belongs. -->
# LIT-265: Large Batch Optimization for Deep Learning: Training BERT in 76 minutes
...
Read — the reading is [NOTE-132](../notes.d/NOTE-132.md) — and the source of [SOTA-tmp28q6x](../practices.d/SOTA-tmp28q6x.md). Arrived in
the imported batch, which brought in the batch-size line: how large a batch
buys speed, and what it costs.

Filed initially as a contradiction of [SOTA-218](../practices.d/SOTA-218.md), which it is not. This paper
cites [LIT-058](LIT-058.md) approvingly in its related work and reports its own large-batch
results under the heading *untuned*. [THEORY-tmpih985](../theory.d/THEORY-tmpih985.md) is where the two are read
together.
