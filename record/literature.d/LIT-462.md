...
- version: 2
  date: '2026-09-23'
  note: >-
    Title corrected to the paper's spelling, μP rather than muP. `luria
    lint` reported the ASCII form as a source mismatch against arXiv.
tags:
...
# LIT-462: Spectral Condition for μP under Width-Depth Scaling
