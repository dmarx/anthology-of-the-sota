...
- version: 2
  ...
  note: >-
    ...
    LIT-725 supplies infidelity and max-sensitivity, and with them the
...
- **The two metrics it scores with are now held, and one of them needs a
  caveat this note reported without.** [LIT-725](LIT-725.md) defines both.
  ...
  to anyone else's. [SOTA-435](../practices.d/SOTA-435.md) is the practice.
