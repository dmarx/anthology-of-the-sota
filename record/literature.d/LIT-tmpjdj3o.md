...
summary: >-
  ...
  batch size.
---
# LIT-tmpjdj3o: A Bayesian Perspective on Generalization and Stochastic Gradient Descent
...
Read — the reading is [NOTE-tmp8fnry](../notes.d/NOTE-tmp8fnry.md). Arrived in the imported batch, which
