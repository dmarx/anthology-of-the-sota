...
summary: >-
  ...
  group.
---
# NOTE-147: Emergent Behavior in Flocks
...
- Stochastic Cucker-Smale with Randomly Switching Topologies (Dong et al.
  2019) ([LIT-353](../literature.d/LIT-353.md)) — Direct extension to sparse and stochastic
...
- Effective Theory / Ginzburg-Landau phase transition in coupled networks
  ([LIT-311](../literature.d/LIT-311.md)) — The β = 1/2 phase transition in CS corresponds directly
...
- Gossip ULA / EXTRA SGLD ([LIT-366](../literature.d/LIT-366.md)) — Gossip ULA achieves gradient
