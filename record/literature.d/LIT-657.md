...
---
<!-- inactive-ok-file: SOTA-251, SOTA-398 — Proposed practices this paper bears on; named as what it informs, not as settled advice -->


# LIT-657: Patch n' Pack: NaViT, a Vision Transformer for any Aspect Ratio and Resolution
...
its own. Aspect ratio on its own is barely tested. [SOTA-398](../practices.d/SOTA-398.md) records
