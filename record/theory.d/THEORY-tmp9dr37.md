...
date: '2026-09-15'
source:
# Four groups, within about a year, by four routes. LIT-tmp8li9l is primary:
...
# THEORY-tmp9dr37: A wide two-layer network's training dynamics are a gradient flow on the distribution of its neurons, and that flow is convex
...
depend on `N`. [LIT-tmp8li9l](../literature.d/LIT-tmp8li9l.md) bounds the gap between the finite-`N` optimum and
...
tangent kernel limit ([LIT-tmpx1n54](../literature.d/LIT-tmpx1n54.md)), in which the features do not move and
...
<!-- inactive-ok-block: THEORY-tmpgtvl1 — Proposed, and this paragraph is
     about the relationship between the two accounts -->
[THEORY-tmpgtvl1](THEORY-tmpgtvl1.md) and, through it, to averaging weights across workers.

## Why it is `Active`

**Four groups, four routes, about a year.** [LIT-tmp8li9l](../literature.d/LIT-tmp8li9l.md) reaches it through
propagation of chaos and a direct PDE limit; [LIT-tmpy2bnh](../literature.d/LIT-tmpy2bnh.md) through an
interacting particle system, and adds that the approximation error scales as
`O(1/n)` in width rather than `O(1/sqrt(n))`; [LIT-tmp7pep0](../literature.d/LIT-tmp7pep0.md) through a law of
large numbers for the empirical measure; [LIT-tmpge342](../literature.d/LIT-tmpge342.md) through optimal
...
[LIT-tmp8li9l](../literature.d/LIT-tmp8li9l.md) needs an explicit added diffusion term — entropy regularization,
