...
- version: 2
  date: '2026-09-18'
  note: >-
    Adds `adaptation-and-tuning`. The paper studies what ES post-training does; `analysis-and-evaluation` named the kind of work and left the subject unnamed, which is why its relations to LIT-127 and LIT-211 read as asserting a commonality nothing expressed (ADR-tmphn2vp).
- version: 3
  date: '2026-09-18'
  note: >-
