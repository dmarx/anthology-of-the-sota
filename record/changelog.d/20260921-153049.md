...
- **Auditing Political Exposure Bias** (`LIT-tmpq6fna` / `NOTE-tmpz4t8g`), Ye,
...
- **`SOTA-tmpxtcgk`** — to measure what a deployed recommender does, use
  sock-puppets that never interact, follow sets curated to your question, and
  exposure weighted by rank. `Proposed`, `unreplicated`.
- **`THEORY-tmp0qzbq`** — personalizing a feed concentrates what it shows
