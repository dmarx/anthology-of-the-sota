...
summary: >-
  ...
  annealing schedule.
---
# LIT-327: A Growing Neural Gas Network Learns Topologies
...
Growing neural gas: insert units where the accumulated error is largest, so
the network finds its own size and topology without an annealing schedule.
