...
---
# NOTE-tmpwkc41: PowerSGD: Practical Low-Rank Gradient Compression for Distributed Optimization
...
- 1-bit Adam: Communication Efficient Large-Scale Training with Adam's
  Convergence Speed ([LIT-tmpaqpkd](../literature.d/LIT-tmpaqpkd.md)) — 1-bit Adam cites PowerSGD as a state-
