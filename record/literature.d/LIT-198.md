...
**The practice is [SOTA-161](../practices.d/SOTA-161.md), `Active`**, extending [SOTA-085](../practices.d/SOTA-085.md). That practice
says to use flash attention wherever the hardware supports it, because the
result is exact, and names the order of accumulation as the one numerical
change. [SOTA-161](../practices.d/SOTA-161.md) is where that change is shown to matter.
