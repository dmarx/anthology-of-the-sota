...
summary: >-
  ...
  worker availability.
---
# NOTE-tmptbs7j: DiLoCo: Distributed Low-Communication Training of Language Models
...
- Local SGD Converges Fast and Communicates Little ([LIT-tmpx82es](../literature.d/LIT-tmpx82es.md)) — DiLoCo
  applies local SGD ideas at LLM scale with infrequent synchronization
  justified by Stich's convergence analysis.
- Don't Use Large Mini-Batches, Use Local SGD ([LIT-tmpxaxzy](../literature.d/LIT-tmpxaxzy.md)) — Post-local
...
- SlowMo: Improving Communication-Efficient Distributed SGD with Slow
  Momentum ([LIT-tmpz7s7p](../literature.d/LIT-tmpz7s7p.md)) — SlowMo's slow outer momentum directly inspired
