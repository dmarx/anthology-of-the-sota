...
**7 documents cited without acknowledgement.** Not listed: 1145 citations someone has already vouched for with an `inactive-ok:` comment at the citing site.
...
- record/theory.d/THEORY-058.md:36: annotation no longer applies — SOTA-200, SOTA-312 is Active now
- record/theory.d/THEORY-059.md:35: annotation no longer applies — SOTA-314 is Active now
