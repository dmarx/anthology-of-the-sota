...
---
# NOTE-tmpmtu16: SWARM Parallelism: Training Large Models Can Be Surprisingly Communication-Efficient
...
- Towards Crowdsourced Training of Large Neural Networks using Decentralized
  Mixture-of-Experts ([LIT-tmp1lc2w](../literature.d/LIT-tmp1lc2w.md)) — Extends the decentralized training
  infrastructure (DHT-based coordination) to pipeline-parallel settings
  capable of training billion-scale dense models.
- Distributed Deep Learning in Open Collaborations ([LIT-tmplekdf](../literature.d/LIT-tmplekdf.md)) — Builds
...
- OpenDiLoCo: An Open-Source Framework for Globally Distributed Low-
  Communication Training ([LIT-tmp323u1](../literature.d/LIT-tmp323u1.md)) — OpenDiLoCo uses Hivemind (which
...
- Protocol Models: Scaling Decentralized Training with Communication-
  Efficient Model Parallelism ([LIT-tmpuc58z](../literature.d/LIT-tmpuc58z.md)) — Protocol Models cites the
