...
- version: 2
  date: '2026-09-18'
  note: >-
    Adds `adaptation-and-tuning` and `training-optimization`. The title says fine-tuning and the claim is about curvature and variance in the optimization landscape; neither subject was named (ADR-tmphn2vp).
tags:
