...
consensus_note: >-
  ...
  diagnostic (LIT-230) and from an estimator derivation (LIT-232),
...
date: '2026-09-15'
source:
# Two independent arguments for one instruction. LIT-232 is primary: it
...
implementations: []
summary: >-
  Kaya and Hashemi (2026), [LIT-232](../literature.d/LIT-232.md), and Ba et al. (2026), [LIT-230](../literature.d/LIT-230.md) —
...
# SOTA-211: Spend one fitness evaluation per evolution-strategies direction, not an antithetic pair
...
the two rollouts down different paths. [LIT-230](../literature.d/LIT-230.md) measures exactly this:
...
[LIT-232](../literature.d/LIT-232.md)'s LOO-ROLL removes the population-level reward offset with a
...
[LIT-230](../literature.d/LIT-230.md) measures the variance reduction working. Do not carry this
across.
...
[LIT-230](../literature.d/LIT-230.md) reports that the perturbation scale has a two-sided failure
...
alternative to it, and inside [LIT-229](../literature.d/LIT-229.md)'s low-rank machinery in
...
- None released. [LIT-232](../literature.d/LIT-232.md)'s LOO-ROLL is implemented on top of
  [LIT-229](../literature.d/LIT-229.md)'s codebase, retaining seed-based perturbation
