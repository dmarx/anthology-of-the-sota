...
**5 documents cited without acknowledgement.** Not listed: 1707 citations someone has already vouched for with an `inactive-ok:` comment at the citing site.
...
- [`record/practices.d/SOTA-140.md:53`](../../record/practices.d/SOTA-140.md)
...
### LIT-tmpy02tv — not minted here (1 unmarked site)

- [`CLAUDE.md:129`](../../CLAUDE.md)
