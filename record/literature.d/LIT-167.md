...
# LIT-167: Understanding R1-Zero-Like Training: A Critical Perspective
...
The corrective to [LIT-164](LIT-164.md), and the reason [SOTA-130](../practices.d/SOTA-130.md) should stay
...
length bias here, [LIT-168](LIT-168.md) the clipping and sampling behaviour, and
[LIT-180](LIT-180.md) the token-level importance ratio. GRPO is the practice's source
