...
- version: 2
  ...
  note: >-
    ...
    is Nguyen and Salazar's system (LIT-tmprikl1) and the comparison swaps two
...
- **The evidence is modest and clearly bounded, and the baseline is narrower
  ...
  (`LIT-tmprikl1`), whose repository this work starts from and whose five
...
- **QKNorm is ScaleNorm, moved onto the queries and keys.** The source says so
  ...
  `SOTA-192` recommends is `LIT-tmprikl1`'s normalization applied at a
