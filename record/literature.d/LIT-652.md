...
- version: 2
  ...
  note: >-
    ...
    (SOTA-398). The Standing section points to both.
tags:
- generative-modeling
- vision-and-graphics
...
---
<!-- inactive-ok-file: SOTA-386, SOTA-389, SOTA-398 — Proposed practices Sora adopts; named to say it adds adoption, not evidence -->
...
- **Native-size training over fixed crops** has no practice for
  ...
  ([LIT-657](LIT-657.md)), its reference 18, is now filed. It supports
  [SOTA-398](../practices.d/SOTA-398.md), a measured practice for ViT pretraining, which isolates
