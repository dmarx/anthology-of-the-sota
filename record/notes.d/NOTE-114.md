...
---
# NOTE-114: A Necessary and Sufficient Condition for Consensus Over Random Networks
...
- D-PSGD (Can Decentralized Algorithms Outperform Centralized Algorithms?)
  ([LIT-302](../literature.d/LIT-302.md)) — D-PSGD's convergence proof requires a spectral gap
...
- SGP (Stochastic Gradient Push) ([LIT-280](../literature.d/LIT-280.md)) — SGP uses push-sum on
  ...
  sufficient here.
- Gossip ULA (Decentralized Langevin Sampling via EXTRA) ([LIT-366](../literature.d/LIT-366.md)) —
...
- Effective Theory of Neural Network Training (Ginzburg-Landau / coupling
  phase) ([LIT-311](../literature.d/LIT-311.md)) — The coupling condition for the Ginzburg-Landau
