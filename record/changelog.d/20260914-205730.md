<!-- inactive-ok-file: ADR-tmpzo2wa — Proposed. Named as the decision this
...
- **One `topics` vocabulary, shared by the practice registry and the reading
  ...
  twelve. [ADR-tmpzo2wa](record/decisions.d/ADR-tmpzo2wa.md) folds them and says why [ADR-027](record/decisions.d/ADR-027.md)'s deliberate
