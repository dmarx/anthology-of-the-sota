...
---
# NOTE-157: SlowMo: Improving Communication-Efficient Distributed SGD with Slow Momentum
...
- Local SGD Converges Fast and Communicates Little ([LIT-361](../literature.d/LIT-361.md)) — Local
  SGD is one of the primary base optimizers for SlowMo; SlowMo adds a slow
  momentum outer layer on top.
- Don't Use Large Mini-Batches, Use Local SGD ([LIT-362](../literature.d/LIT-362.md)) — Introduces
