...
summary: >-
  ...
  linear speedup.
---
# NOTE-tmpmcac1: Local SGD Converges Fast and Communicates Little
...
- Don't Use Large Mini-Batches, Use Local SGD ([LIT-tmpxaxzy](../literature.d/LIT-tmpxaxzy.md)) — Empirically
...
- SlowMo: Improving Communication-Efficient Distributed SGD with Slow
  Momentum ([LIT-tmpz7s7p](../literature.d/LIT-tmpz7s7p.md)) — Builds on local SGD as a base algorithm, adding
