...
<!-- inactive-ok-block: SOTA-160 — the practice drawn from this paper,
     Proposed, and saying why is what this paragraph does -->
**The practice is [SOTA-160](../practices.d/SOTA-160.md), `Proposed`.** The inference result is what it
