...
---
# NOTE-tmp6nr15: Reconciling modern machine learning practice and the bias-variance trade-off
...
- Goldt et al. 2020 ([LIT-tmpst0ap](../literature.d/LIT-tmpst0ap.md)) — Goldt's ODE framework describes the
