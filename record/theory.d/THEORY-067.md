...
summary: >-
  ...
  [LIT-533](../literature.d/LIT-533.md)), a Sherman–Morrison ridge update in constant depth and `O(d²)`
  width (Akyürek et al., [LIT-532](../literature.d/LIT-532.md)), and `k` Iterative Newton steps in
  `k + 8` layers (Fu et al., [LIT-535](../literature.d/LIT-535.md)). The frame is what survives the
...
`Active`. Nothing in the dispute touches the constructions; [LIT-536](../literature.d/LIT-536.md),
...
behaviour has no iterative reading at all. [LIT-535](../literature.d/LIT-535.md)'s LSTM result is the
