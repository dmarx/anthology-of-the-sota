...
<!-- inactive-ok-block: SOTA-tmpvsqdg — the practice drawn from this paper,
     Proposed, and saying why is what this paragraph does -->
Two practices rest on it, and the split is the point. [SOTA-tmpvsqdg](../practices.d/SOTA-tmpvsqdg.md) is SOAP
itself, `Proposed`: the record recommends Muon ([SOTA-121](../practices.d/SOTA-121.md)) on production
evidence at trillion-parameter scale that SOAP does not have. [SOTA-tmpncfhm](../practices.d/SOTA-tmpncfhm.md)
is the class — precondition with matrices rather than entrywise — and this
paper's equivalence result is what makes that class a real object rather than
a grouping, which is the argument the note had been making in prose.
