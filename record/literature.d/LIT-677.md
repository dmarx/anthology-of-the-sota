...
<!-- inactive-ok-file: SOTA-412 SOTA-264 — both Proposed; named as the practice this
     paper sources and the rival practice it competes with for the same objective -->

# LIT-677: Diffusion Models With Learned Adaptive Noise
...
- **It sources `SOTA-412`**: when the target is likelihood, learn a
