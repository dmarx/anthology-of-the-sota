...
status: Active
status_note: >-
  Promoted by the owner on 2026-09-23 without the event its promotion
  condition named, a theory Rejected while the practice it explained stays
  Active. The scheme had been in use since filing: 84 theories, and 69
  practices that carry `explained_by`.
formerly:
- ADR-tmpvv7zp
...
<!-- inactive-ok-file: SOTA-097 — Superseded, and listed here as one of this decision's own examples; the table is a record of what was surveyed, not a citation of live advice -->
...
<!-- inactive-ok-block: SOTA-010 — Superseded: the move this very
     paragraph asked for and declined to make; ADR-034 made it -->
