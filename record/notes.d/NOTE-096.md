...
---
# NOTE-096: Deep Gradient Compression: Reducing the Communication Bandwidth for Distributed Training
...
- PowerSGD: Practical Low-Rank Gradient Compression for Distributed
  Optimization ([LIT-337](../literature.d/LIT-337.md)) — PowerSGD cites DGC as an approximate top-K
