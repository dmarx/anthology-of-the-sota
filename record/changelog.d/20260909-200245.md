...
- The last four readings, all confirming: `NOTE-tmpct2nt` (*Attention Is All
  You Need* → `SOTA-050`), `NOTE-tmpwwwom` (*Don't Stop Pretraining* →
  `SOTA-033`), `NOTE-tmp17ke7` (*Latent Diffusion* → `SOTA-187`),
  `NOTE-tmpn4y0b` (*Segment Anything* → `SOTA-186`).
