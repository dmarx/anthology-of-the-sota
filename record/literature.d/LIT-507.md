...
summary: >-
  ...
  [LIT-509](LIT-509.md)'s ReLU result is an artifact of non-adaptive binning and that
...
# LIT-507: Adaptive Estimators Show Information Compression in Deep Neural Networks

Chelombiev, Houghton and O'Donnell (2019) — [ARXIV-1902.09037](https://arxiv.org/abs/1902.09037), read
as [NOTE-254](../notes.d/NOTE-254.md).
...
[LIT-509](LIT-509.md); read from its figures it is a third independent demonstration
...
**Its technical criticism is specific and lands.** [LIT-509](LIT-509.md) binned
