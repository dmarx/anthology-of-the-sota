...
- version: 2
  ...
  note: >-
    ...
    be the first thing to read against this one" is now LIT-tmp5z3a0, read, and
...
maps* — read on 2026-09-26 and held as [LIT-tmp5z3a0](LIT-tmp5z3a0.md). It traces this paper's
own headline failure to the input multiplier rather than to gradient
attribution as such ([THEORY-tmp4cch6](../theory.d/THEORY-tmp4cch6.md)), and it is by captum's maintainers, so
