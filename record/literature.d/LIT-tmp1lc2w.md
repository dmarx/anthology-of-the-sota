...
---
# LIT-tmp1lc2w: Towards Crowdsourced Training of Large Neural Networks using Decentralized Mixture-of-Experts
...
Read — the reading is [NOTE-tmpoe1a8](../notes.d/NOTE-tmpoe1a8.md). Arrived in the imported batch, which
