...
- **A third scheme, `NOTE`** (`ADR-tmp2q9cv`), in `record/notes.d`. One
...
- `NOTE-tmpmvx4t` — the first reading, of `LIT-052` (*Scale Efficiently*),
...
Three departures from the supplied schema, all in `ADR-tmp2q9cv`:
