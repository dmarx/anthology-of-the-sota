...
arxiv: '2309.00071'
# Corrective succession (ADR-017). YaRN keeps position interpolation's
# diagnosis and replaces its uniform scaling with a per-wavelength one, on the
# defect it names: stretching every dimension equally destroys the
# high-frequency components and stalls around a scale factor of 8.
corrects:
- LIT-192
first_author: 'Peng'
keywords:
