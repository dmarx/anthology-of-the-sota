...
# SOTA-tmpntee6: Retune the learning rate, momentum and schedule at every batch size you compare, never by a scaling heuristic
...
runs. It gives no cheaper procedure, and [LIT-tmpsizdi](../literature.d/LIT-tmpsizdi.md)'s contrary claim, that a
