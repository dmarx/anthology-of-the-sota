...
- version: 2
  date: '2026-09-20'
  note: >-
    Declares `extends: LIT-tmpnqv3x`. The edge existed in the argument from
...
<!-- inactive-ok-file: THEORY-024 — Proposed since the Kaon control (LIT-tmp6umwv); cited here to say what this paper's account is adjacent to and independent of, which the demotion does not change -->
