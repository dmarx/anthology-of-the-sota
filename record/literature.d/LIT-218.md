...
**Audited by [#121](https://github.com/dmarx/anthology-of-the-sota/issues/121); unsourced and unread.** No reading note. The
third of the cluster with [LIT-215](LIT-215.md) and [LIT-216](LIT-216.md). Its title makes a
claim about capability emergence that [SOTA-200](../practices.d/SOTA-200.md) is directly about, so
reading it would either corroborate or contest an in-force practice.
