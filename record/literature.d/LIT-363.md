...
---
# LIT-363: 'Neural-gas' network for vector quantization and its application to time-series prediction
...
Read — the reading is [NOTE-125](../notes.d/NOTE-125.md). Arrived in the imported batch, which
