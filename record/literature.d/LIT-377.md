...
applied it to summarization. Both are now filed — [LIT-434](LIT-434.md) and
[LIT-433](LIT-433.md) — and the `extends:` field carries the line, so the reading
list walks preference learning → summarization → general instruction
following rather than starting here. [LIT-432](LIT-432.md) is FLAN, the arm this
