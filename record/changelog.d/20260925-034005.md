...
- **Grokked Transformers are Implicit Reasoners** — `LIT-tmppwagl`. Wang, Yue,
...
- **`THEORY-tmp6pl9b`**, `Proposed` — a transformer stores a fact where it
...
- **`SOTA-tmpvsnuz`**, `Proposed`/`unreplicated` — to teach a model to reason
