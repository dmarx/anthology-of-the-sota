...
- SOTA-200
summary: >-
  Schaeffer et al. (2023), [LIT-tmpgnhq2](../literature.d/LIT-tmpgnhq2.md) — if per-token accuracy rises
...
# THEORY-tmpacv6c: A metric that composes or thresholds per-token error turns a smooth capability curve into a sharp one, with nothing happening in the model

## Source

Schaeffer, Miranda and Koyejo (2023), [LIT-tmpgnhq2](../literature.d/LIT-tmpgnhq2.md) — read as
[NOTE-tmpnb7kf](../notes.d/NOTE-tmpnb7kf.md).
...
**It does not cover intermediate-step emergence.** [LIT-tmpc4fk2](../literature.d/LIT-tmpc4fk2.md) §5.1
