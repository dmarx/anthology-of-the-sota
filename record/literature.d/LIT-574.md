...
# LIT-574: Does Localization Inform Editing? Surprising Differences in Causality-Based Localization vs. Knowledge Editing in Language Models
...
**Filed from `#163`** (LARQL). It `corrects` ROME ([LIT-578](LIT-578.md)), and it is
why the localization-to-editing account is filed `Rejected`
([THEORY-082](../theory.d/THEORY-082.md)).
...
Read — [NOTE-313](../notes.d/NOTE-313.md).
<!-- inactive-ok-file: THEORY-082 — Rejected on this paper's evidence, filed in this same contribution -->
