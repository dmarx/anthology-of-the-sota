...
---
# NOTE-tmp4hp6m: Spectrum Dependent Learning Curves in Kernel Regression and Wide Neural Networks
...
- Kaplan et al. 2020 ([LIT-028](../literature.d/LIT-028.md)) — Kaplan empirically fits power-law + floor.
  ...
  curve family.
- Caballero et al. 2023 ([LIT-tmpnvhj9](../literature.d/LIT-tmpnvhj9.md)) — BNSL handles the case where two
