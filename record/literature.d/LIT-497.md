...
— it attributes to Yu et al. (2021), now filed as [LIT-tmpov7yl](../literature.d/LIT-tmpov7yl.md)
and declared here as a second `extends`. Reading the origin showed this paper
reimplements the idea rather than reproducing it: ViT-VQGAN *factorizes*,
keeping a wide embedding behind a narrow lookup, where this makes the whole
codebook 8-dimensional. Both work; nobody has compared them.
