...
- version: 2
  ...
  note: >-
    ...
    instrument. Darcet et al. (LIT-tmpic7xb) measure 2.37% of DINOv2 ViT-g's
...
later, by the same group, in `LIT-tmpic7xb`.
...
instead. The account is `THEORY-tmpjr84g`: the model is using redundant patches
...
Registers recover most of it — **55.4**, `SOTA-tmpnogfc` — and not all of it,
