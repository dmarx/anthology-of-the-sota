...
- version: 2
  ...
  note: >-
    ...
    §1. That review is now filed (LIT-tmpwxmrr) and read. It has the
...
- **Critical distance is the book's; the other two optimal radii are not.**
  ...
  Kanerva's 1993 review. The review, filed as `LIT-tmpwxmrr` and read in full,
...
- *Which biological claims the book makes itself.* Still open. Kanerva's own
  ...
  review (`LIT-tmpwxmrr`). Whether the book says the same was not checked.
