...
summary: >-
  ...
  where μ_t = Law(X_t).
---
# NOTE-090: Topics in propagation of chaos
...
- Consensus Based Sampling ([LIT-262](../literature.d/LIT-262.md)) — CBS is an applied-math
...
- Global convergence of neuron birth-death dynamics (Rotskoff, Vanden-
  Eijnden) ([LIT-365](../literature.d/LIT-365.md)) — Uses the same McKean-Vlasov mean-field limit to
