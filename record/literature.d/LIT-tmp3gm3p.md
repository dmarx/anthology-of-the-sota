...
summary: >-
  ...
  next local step.
---
# LIT-tmp3gm3p: Stochastic Gradient Push for Distributed Deep Learning
...
Read — the reading is [NOTE-tmpwigvz](../notes.d/NOTE-tmpwigvz.md). Arrived in the imported batch, which
