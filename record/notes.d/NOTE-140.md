...
---
# NOTE-140: Mean Field Analysis of Neural Networks: A Law of Large Numbers
...
- A mean field view of the landscape of two-layer neural networks (Mei,
  Montanari, Nguyen) ([LIT-271](../literature.d/LIT-271.md)) — Concurrent work deriving a similar
...
- Neural Networks as Interacting Particle Systems (Rotskoff, Vanden-Eijnden)
  ([LIT-365](../literature.d/LIT-365.md)) — Concurrent interacting-particle-system view of wide
  neural networks.
