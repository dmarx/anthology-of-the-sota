...
- **`LIT-tmpesppq`** — *Language Modeling by Language Models* (Cheng, Clark
  and Richardson, 2025), read as `NOTE-tmpavng3`. The largest automated
...
- **`SOTA-tmpe69t0`** — generate a long program unit by unit, freezing each
