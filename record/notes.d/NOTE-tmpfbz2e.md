...
---
# NOTE-tmpfbz2e: The Variational Formulation of the Fokker-Planck Equation
...
- Consensus Based Sampling ([LIT-tmp62l1g](../literature.d/LIT-tmp62l1g.md)) — CBS uses the W₂ gradient flow
...
- Convex Analysis of the Mean Field Langevin Dynamics ([LIT-tmpbveca](../literature.d/LIT-tmpbveca.md)) —
