...
---
# NOTE-tmpxa9f4: signSGD: Compressed Optimisation for Non-Convex Problems
...
- PowerSGD: Practical Low-Rank Gradient Compression for Distributed
  Optimization ([LIT-tmpsizdi](../literature.d/LIT-tmpsizdi.md)) — PowerSGD benchmarks against Signum as the
...
- 1-bit Adam: Communication Efficient Large-Scale Training with Adam's
  Convergence Speed ([LIT-tmpaqpkd](../literature.d/LIT-tmpaqpkd.md)) — 1-bit Adam builds on the 1-bit
