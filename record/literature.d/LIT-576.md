...
# LIT-576: Mass-Editing Memory in a Transformer
...
**Filed from `#163`** (LARQL). It `extends` ROME and sources [SOTA-347](../practices.d/SOTA-347.md),
which RippleEdits ([LIT-577](LIT-577.md)) contests.
...
MEMIT did not ([LIT-577](LIT-577.md)).

Read — [NOTE-316](../notes.d/NOTE-316.md).
<!-- inactive-ok-file: SOTA-347 — Proposed and contested, filed in this same contribution from this paper -->
