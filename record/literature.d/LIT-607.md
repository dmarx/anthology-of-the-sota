...
- version: 2
  date: '2026-09-23'
  note: >-
    Also `corrects` Baroni et al. (2014), LIT-608, filed after it.
- version: 3
  date: '2026-09-23'
  note: >-
    `extends` Levy and Goldberg (2014), LIT-tmppsaaa, the factorization result
    it builds on, filed after it.
tags:
...
- **The question** (§1). Baroni et al. (2014) found prediction-based
  ...
  implicitly factorizes a shifted PMI matrix (Levy and Goldberg 2014,
  [LIT-tmppsaaa](LIT-tmppsaaa.md)), the
...
- **No method wins consistently** (§5.3, Table 5). On similarity, SVD beats
  ...
  ([LIT-608](LIT-608.md)) came from pre-tuned word2vec against vanilla PPMI and SVD,
  with SVD at its worst setting (eig = 1). It is filed as `corrects` that
  paper.
