...
- version: 2
  date: '2026-09-25'
  note: >-
    Kingma and Gao filed (LIT-tmpqjbx0). The pointers to it are updated, and
    the identity is scoped to the unshifted cosine.
tags:
- generative-modeling
...
# LIT-678: Diffusion Meets Flow Matching: Two Sides of the Same Coin
...
not derived here.** The post cites Kingma & Gao (2023) App. D.2–3 for it,
now [LIT-tmpqjbx0](LIT-tmpqjbx0.md). That derivation holds for the unshifted cosine only.
...
- **Anyone citing this post for the weighting identity is citing a pointer.**
  The derivation is in [LIT-tmpqjbx0](LIT-tmpqjbx0.md).
...
It sources **`THEORY-106`**: under a Gaussian source, a comparison
...
**Two follow-ups this note made visible.** Kingma & Gao, which carries the
weighting identity, is now filed as [LIT-tmpqjbx0](LIT-tmpqjbx0.md), and this post extends it.
And [LIT-626](LIT-626.md)'s phrase
