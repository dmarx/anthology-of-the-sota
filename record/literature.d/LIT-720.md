...
formerly:
- LIT-tmp7nrwv
superseded_by: LIT-714
status_note: >-
  A duplicate. `2312.02696` was already held as LIT-714, filed hours earlier in
  #375 and merged while this note was being written; LIT-714 is the fuller
  reading — the whole ablation ladder, the metric-disagreement finding, and
  NOTE-370 with the appendices — and ten documents cite it against this note's
  four, all of which were its own. Retired rather than deleted so the mistake
  stays visible and the `formerly:` alias keeps any stray citation resolving.
  Nothing here is lost: everything this note said, LIT-714 or SOTA-428 says
  already, including the learning-rate bracket.
...
<!-- inactive-ok-file: SOTA-415, SOTA-408, SOTA-217, SOTA-156, SOTA-288, THEORY-111 — every weight-averaging practice in this record is Proposed, and this note cites them as the cluster whose gap it fills, not as settled support: the point being made is that six not-yet-in-force recommendations all work around the choice this paper removes. THEORY-111 is the account this note introduces. -->

<!-- inactive-ok-file: SOTA-428, SOTA-432, THEORY-111 — this note is Superseded itself, a same-day duplicate of LIT-714. SOTA-428 is the live practice named in its status note as what replaces the duplicate's; SOTA-432 and THEORY-111 are the rest of the retired unit. A retired document citing its own replacement and its own siblings is the record of the mistake, not a reliance on anything. -->

# LIT-720: Analyzing and Improving the Training Dynamics of Diffusion Models
...
- **The result that matters outside diffusion (Fig. 12).** A sweet spot in the
  ...
  averaging length was frozen. [THEORY-111](../theory.d/THEORY-111.md) is that claim.
...
- [SOTA-432](../practices.d/SOTA-432.md), the recommendation;
- [THEORY-111](../theory.d/THEORY-111.md), the entanglement account, which the record had no theory for;
