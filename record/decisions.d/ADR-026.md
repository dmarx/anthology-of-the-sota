...
<!-- inactive-ok-file: ADR-024 — Superseded, and named as the options document this one did not touch -->
...
`analysis-and-evaluation` (`ADR-027`) → thirteen here. <!-- inactive-ok: ADR-027 — Superseded, and named
here as a dated step in the vocabulary's history, which the supersession
does not change --> Five decisions, and
