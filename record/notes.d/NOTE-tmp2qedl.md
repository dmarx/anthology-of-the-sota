...
---
# NOTE-tmp2qedl: The Kuramoto model: A simple paradigm for synchronization phenomena
...
- Consensus Based Sampling ([LIT-tmp62l1g](../literature.d/LIT-tmp62l1g.md)) — CBS is the sampling analog of
