...
---
# LIT-tmpz6dsu: Moshpit SGD: Communication-Efficient Decentralized Training on Heterogeneous Unreliable Devices
...
Read — the reading is [NOTE-tmp0uwyb](../notes.d/NOTE-tmp0uwyb.md). Arrived in the imported batch, which
