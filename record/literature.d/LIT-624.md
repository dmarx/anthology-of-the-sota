...
- **Compression doubles in every dimension, with no loss on its own
  ...
  15). Open-Sora 2.0's Table 1 (LIT-634) measures the same VAE well below
  HunyuanVideo's: LPIPS 0.082 against 0.046, PSNR 28.719 against 30.240. The
  latent is 64 channels against 16 (per LIT-634), so the information ratio
  is 2×, not 8×. This is the
...
- **"State-of-the-art" reconstruction** is contradicted by Table 15, where
  HunyuanVideo's PSNR is higher. An outside measurement (LIT-634, Table 1)
