...
---
# NOTE-149: Emergence of stochastic flocking for the discrete Cucker-Smale model with randomly switching topologies
...
- Gossip ULA / EXTRA SGLD ([LIT-366](../literature.d/LIT-366.md)) — Gossip ULA uses EXTRA correction
