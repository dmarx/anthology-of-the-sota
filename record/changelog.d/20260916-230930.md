...
- A decision that the record may file a practice whose recommendation is
  ...
  as `Rejected` to say *do not do this* ([ADR-tmpvdpb9](record/decisions.d/ADR-tmpvdpb9.md), closing [#88](https://github.com/dmarx/anthology-of-the-sota/issues/88)). The entry
