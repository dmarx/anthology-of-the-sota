...
<!-- inactive-ok-file: SOTA-271 — Proposed, named in the Consequences list of
     documents that gained a tag; a practice's standing is unaffected by which
     topic it files under -->

# ADR-052: Two more topics: one that had a trailing clause for a home, and one that had nothing
