...
<!-- inactive-ok-block: SOTA-tmp0cmo2 — the practice drawn from this paper,
     Proposed, and saying why is what this paragraph does -->
**The practice is [SOTA-tmp0cmo2](../practices.d/SOTA-tmp0cmo2.md), `Proposed`** — and it is the *trunk*, not
