...
- version: 2
  date: '2026-09-18'
  note: >-
    Adds `attention-techniques`. That topic's blurb covers "alternative mechanisms", which is what a selective state-space model is, and LIT-162 — in this same line — establishes that SSMs and attention are one object seen from two ends. It is the value that names the line: the six-member component held nothing in common until it was written down (ADR-049).
tags:
- model-architecture
