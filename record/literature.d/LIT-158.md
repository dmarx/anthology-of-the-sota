...
The contribution is not an algorithm but a distribution strategy for one, and
its transferable content — that sharding a preconditioner's blocks across
ranks holds the penalty to 10% — is a *condition* on a recommendation rather
than a recommendation. It is filed as a source of [SOTA-tmpncfhm](../practices.d/SOTA-tmpncfhm.md) and stated
there, in the section about what the class costs, which is where a reader
