...
**1 document cited without acknowledgement.** Not listed: 15 citations someone has already vouched for with an `inactive-ok:` comment at the citing site.
...
### [LIT-041](../../record/literature.d/LIT-041.md) — Rejected

Clusterability in Neural Networks

1 citation in 1 file awaits a look; 5 other citations of it are acknowledged.

- [`record/literature.d/LIT-031.md:4`](../../record/literature.d/LIT-031.md)
