...
- version: 3
  date: '2026-09-25'
  note: >-
    Model soups is filed as LIT-675, so the list of what remains absent from
...
initialization, now [LIT-674](LIT-674.md), and model soups, now [LIT-675](LIT-675.md). Snapshot
