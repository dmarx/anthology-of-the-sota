...
# Secondary, restored: it is an analysis of what RoPE does to attention heads (ADR-tmpoxkk7).
...
- 'attention-heads'
- 'frequency-analysis'
# Corrective succession (ADR-017): RoPE's own decay justification does not hold, and its lowest frequencies cannot stay robust over long context.
corrects:
- LIT-045
...
# LIT-210: Round and Round We Go! What makes Rotary Positional Encodings useful?
