...
---
# NOTE-137: Towards Crowdsourced Training of Large Neural Networks using Decentralized Mixture-of-Experts
...
- Distributed Deep Learning in Open Collaborations ([LIT-316](../literature.d/LIT-316.md)) — DeDLOC
...
- SWARM Parallelism: Training Large Models Can Be Surprisingly
  Communication-Efficient ([LIT-303](../literature.d/LIT-303.md)) — SWARM parallelism extends the
