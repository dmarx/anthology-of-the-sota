...
- version: 2
  date: '2026-09-07'
  note: >-
    Superseded by SOTA-109. the shared key/value projections that are multi-query attention had stood Active beside
...
# SOTA-024: Keep key/value projections shared across heads while query projections remain separate
...
all of them, which keeps most of multi-query attention's shared key/value projections's cache saving without its quality
