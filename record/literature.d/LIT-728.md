...
summary: >-
  ...
  backprop ([LIT-727](LIT-727.md)) is explicitly "a new variant of", and so is the
...
# LIT-728: Visualizing and Understanding Convolutional Networks
...
Filed with [LIT-727](LIT-727.md) as a pair, because guided backpropagation is
