...
<!-- inactive-ok-file: THEORY-072, THEORY-073, THEORY-074, SOTA-325 —
     all Proposed, and named as the DOCUMENTS this decision retags or declines
     to retag, which is what a taxonomy decision has to enumerate. None is cited as a recommendation. -->
# ADR-056: capability-thresholds: whether a capability arrives abruptly is a claim, not a method
