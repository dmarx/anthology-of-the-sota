...
# LIT-564: Unpaired Image-to-Image Translation using Cycle-Consistent Adversarial Networks
...
**Filed from `#163`** (CycleGAN). Sources [SOTA-339](../practices.d/SOTA-339.md), scoped to
appearance changes.
...
Read — [NOTE-302](../notes.d/NOTE-302.md).
