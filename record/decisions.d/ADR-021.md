...
the list, which is the second test in [DP-009](../../docs/design-principles.md#dp-9).
...
- **Leave the seven and let serving practices scatter.** What has been
  ...
  is [DP-009](../../docs/design-principles.md#dp-9)'s reading (1).
...
`Graph.inbound()` already exists — and unlike [DP-009](../../docs/design-principles.md#dp-9)'s second test it
