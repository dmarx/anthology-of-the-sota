...
summary: >-
  ...
  **3.5×** memory reduction on 12B FLUX.1. Read as [NOTE-257](../notes.d/NOTE-257.md).
---
...
# LIT-512: SVDQuant: Absorbing Outliers by Low-Rank Components for 4-Bit Diffusion Models

Li, Lin, Zhang, Cai, Li, Guo, Xie, Meng, Zhu and Han (2024) —
[ARXIV-2411.05007](https://arxiv.org/abs/2411.05007), read as [NOTE-257](../notes.d/NOTE-257.md).
...
**Its contribution to the record is two documents.** [SOTA-314](../practices.d/SOTA-314.md) takes
the recommendation; [THEORY-059](../theory.d/THEORY-059.md) takes the spectral argument
