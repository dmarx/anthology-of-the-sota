...
- version: 2
  date: '2026-09-25'
  note: >-
    Kingma and Gao filed (LIT-692). The pointers to it are updated, and
...
now [LIT-692](LIT-692.md). That derivation holds for the unshifted cosine only.
...
- **Anyone citing this post for the weighting identity is citing a pointer.**
  The derivation is in [LIT-692](LIT-692.md).
...
weighting identity, is now filed as [LIT-692](LIT-692.md), and this post extends it.
