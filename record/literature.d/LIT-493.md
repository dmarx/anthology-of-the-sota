...
# LIT-493: Language Modeling by Language Models

Cheng, Clark and Richardson (2025) —
[ARXIV-2506.20249](https://arxiv.org/abs/2506.20249), read as [NOTE-242](../notes.d/NOTE-242.md).
...
fixed model — and the record had nothing on it. `SOTA-304` is that
practice.
