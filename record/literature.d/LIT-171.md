...
# LIT-171: Auxiliary-Loss-Free Load Balancing Strategy for Mixture-of-Experts
...
a loss — with a mechanism, an ablation and adoption at 671B ([LIT-160](LIT-160.md))
...
([LIT-170](LIT-170.md)), the load-balancing fix here, and RL that is unstable on MoE
specifically ([LIT-180](LIT-180.md)) — three practices' worth of material with nowhere
to sit.
