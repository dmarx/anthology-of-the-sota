...
---
# LIT-tmpzenzq: LAYUP: Asynchronous decentralized gradient descent with LAYer-wise UPdates
...
Read — the reading is [NOTE-tmpvsbd3](../notes.d/NOTE-tmpvsbd3.md). Arrived in the imported batch, which
