...
- version: 2
  date: '2026-09-24'
  note: >-
    The resolution shift is no longer described as new with this paper.
    Simple diffusion and Chen (2023), now filed, originate and measure it,
    and §5.3.2 credits Hoogeboom et al. Fig. 6's preference sweep is noted.
tags:
- generative-modeling
- model-architecture
- multimodal-learning
...
**Two instructions here were new to the record.** Resolution-dependent
timestep shifting ([SOTA-263](../practices.d/SOTA-263.md)) was not new to the field. Simple diffusion
([LIT-tmpu1h5o](LIT-tmpu1h5o.md)) and Chen ([LIT-tmpnbpgd](LIT-tmpnbpgd.md)) derived and measured it 14 months
earlier, and §5.3.2 here says the shift is "similar to (Hoogeboom et al.,
2023)". What this paper adds is the rectified-flow derivation and a
human-preference sweep of the sampling shift (Fig. 6), which chose α = 3.0
where its own formula gives 4. And MMDiT ([SOTA-262](../practices.d/SOTA-262.md))
