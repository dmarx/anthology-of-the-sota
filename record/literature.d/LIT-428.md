...
# LIT-428: Transformers are RNNs: Fast Autoregressive Transformers with Linear Attention
...
the forgetting problem from one direction; `LIT-431` and the RWKV line
