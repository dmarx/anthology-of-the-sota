...
summary: >-
  ...
  collapse is a hypothesis in the paper, not a result, and [LIT-593](LIT-593.md)
  disputes which part is doing the work.
---

# LIT-594: Bootstrap your own latent: A new approach to self-supervised Learning
...
documents finally get their sources. Sources [SOTA-365](../practices.d/SOTA-365.md) with
[LIT-593](LIT-593.md).
...
*explanation* is a separate question, and it is contested: [THEORY-087](../theory.d/THEORY-087.md)
files the dispute, in which `LIT-593` removes the momentum encoder BYOL
