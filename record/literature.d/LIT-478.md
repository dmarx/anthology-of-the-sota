...
- version: 3
  date: '2026-09-25'
  note: >-
    Model soups is filed as LIT-tmpay0h1, so the list of what remains absent from
    the family this note named is down to snapshot ensembles and Polyak
    averaging. Keeping the list current is the point of having written it.
tags:
...
initialization, now [LIT-674](LIT-674.md), and model soups, now [LIT-tmpay0h1](LIT-tmpay0h1.md). Snapshot
ensembles and Polyak averaging are still absent.
