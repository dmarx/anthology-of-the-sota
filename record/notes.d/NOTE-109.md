...
---
# NOTE-109: Communication-Efficient Learning of Deep Networks from Decentralized Data
...
- Epidemic Learning: Boosting Decentralized Learning with Randomized
  Communication ([LIT-315](../literature.d/LIT-315.md)) — Builds on federated/decentralized learning
...
- Achieving Tighter Finite-Time Rates for Heterogeneous Federated Stochastic
  Approximation under Markovian Sampling ([LIT-288](../literature.d/LIT-288.md)) — Provides
