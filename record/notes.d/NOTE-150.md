...
---
# NOTE-150: LAYUP: Asynchronous decentralized gradient descent with LAYer-wise UPdates
...
- Hogwild!: A Lock-Free Approach to Parallelizing Stochastic Gradient
  Descent ([LIT-279](../literature.d/LIT-279.md)) — Adopts Hogwild!'s lock-free shared-memory update
