...
- version: 2
  ...
  note: >-
    ...
    draft model: DeepSeek-V4's full report (NOTE-361) keeps it only as a
    training objective.
tags:
...
its own evidence: DeepSeek-V4's full report ([NOTE-361](../notes.d/NOTE-361.md)) keeps it purely as
