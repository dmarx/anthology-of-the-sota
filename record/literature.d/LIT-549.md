...
# LIT-549: ReFT: Representation Finetuning for Language Models
...
parameter count. It sources [SOTA-329](../practices.d/SOTA-329.md), which is scoped to where the
...
Read — [NOTE-290](../notes.d/NOTE-290.md).
