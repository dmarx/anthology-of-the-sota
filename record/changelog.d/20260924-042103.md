...
- **Better plain ViT baselines** — `LIT-tmp5t7v1`. Unit 2 of `#326`, reversed
...
- **`SOTA-tmp7zgk5`** — the recipe, with each change's worth from the
...
- **`SOTA-tmp06fr2`**, `Proposed` — hold out a slice of *train* for model
