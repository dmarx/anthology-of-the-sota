...
# SOTA-tmpb5sfm: Freeze Adam's variance term after a warmup before compressing its update, and never compress the update directly
...
Two settings, both from [LIT-tmpaqpkd](../literature.d/LIT-tmpaqpkd.md): the warmup must be at least as long as
...
Error feedback ([SOTA-tmp5wyoh](SOTA-tmp5wyoh.md)) carries a residual forward on the assumption
...
optimized. [LIT-tmpaqpkd](../literature.d/LIT-tmpaqpkd.md) reports matched convergence; nothing in this record
checks what it does to a run long enough for the preconditioner to go stale.

**The record has a practice this contradicts in spirit.** [SOTA-tmpntee6](SOTA-tmpntee6.md) says
