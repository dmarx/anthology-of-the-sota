...
number: 609
status: Superseded
superseded_by: LIT-603
status_note: a duplicate of LIT-603, filed concurrently by #317 after LIT-603 merged in #316
formerly:
- LIT-tmpbcdbf
...
- version: 2
  date: '2026-09-23'
  note: >-
    Retired as a duplicate of LIT-603 (same arXiv identifier), which
    merged first. SOTA-381 and SOTA-382 now cite LIT-603.
tags:
...
> **Duplicate, retired.** This paper was already filed as [LIT-603](LIT-603.md), and the
> record requires one entry per arXiv identifier. This entry's body is kept
> as written; [LIT-603](LIT-603.md) is the one to cite.

# LIT-609: Distributed Representations of Words and Phrases and their Compositionality
...
- **Subsampling frequent words does two things at once.** It gives
  ...
  enough to be worth its own document — [SOTA-382](../practices.d/SOTA-382.md).
...
Unit G of `#304`. It sources [SOTA-381](../practices.d/SOTA-381.md) (sample negatives; let the count
fall with data) and [SOTA-382](../practices.d/SOTA-382.md) (subsample frequent tokens).
...
finding that batch-size gaps close with longer training, and `SOTA-377`'s
