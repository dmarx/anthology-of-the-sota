...
---
# NOTE-126: Consensus Problems in Networks of Agents With Switching Topology and Time-Delays
...
- D-PSGD (Can Decentralized Algorithms Outperform Centralized Algorithms?)
  ([LIT-302](../literature.d/LIT-302.md)) — D-PSGD's spectral gap condition ρ = max_{i≥2} |λ_i(W)| <
