...
- version: 2
  ...
  note: >-
    ...
    is LIT-730 and the account is THEORY-115: guided backprop recovers
...
summary: >-
  ...
  non-linear and which it defers to Nie et al. (2018), now LIT-730.
---
...
- **And a story the paper rules out by name.** "Other than argued in (Gu et al.
  ...
  Pooling switches." Read against [LIT-730](LIT-730.md), which finds
...
later as [LIT-730](LIT-730.md) (its identifier was resolved against arXiv rather than
...
| Guided Backprop, Deconv, RectGrad | partial image recovery | [THEORY-115](../theory.d/THEORY-115.md) |
