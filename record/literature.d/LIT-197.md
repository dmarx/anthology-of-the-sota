...
<!-- inactive-ok-block: SOTA-tmpa81q9 — Proposed, named as the other half of
     the same decision -->
**The practice is [SOTA-tmphbtjn](../practices.d/SOTA-tmphbtjn.md), `Active`.** It carries the regime table —
direct-cast at 8 bits, fine-tuning at 6, training at 6, weights only at 4 —
and the clause the paper states as a result rather than an aside: 6-bit MX
trains to FP32 accuracy *without modifications to the training recipe*.
[SOTA-tmpa81q9](../practices.d/SOTA-tmpa81q9.md) is the other half, on where in the pipeline the low precision
can sit.
