...
# LIT-579: Where Did the Gap Go? Reassessing the Long-Range Graph Benchmark
...
`compared_against` GIN ([LIT-580](LIT-580.md)), whose edge-feature variant GINE is
one of the retuned baselines. It sources [SOTA-349](../practices.d/SOTA-349.md).
...
Read — [NOTE-317](../notes.d/NOTE-317.md).
