...
- The architecture cluster's sources, third batch of #58 and the first run
  under ADR-017 rather than under a rule invented mid-pass. Nine practices
  examined, five changed.
  - `SOTA-132` is the one #58 flagged. Four adopters come **out** of
    ...
    countability ADR-010 wanted. `consensus: emerging`.
