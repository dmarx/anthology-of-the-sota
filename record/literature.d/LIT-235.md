...
- version: 2
  date: '2026-09-18'
  note: >-
    Adds `adaptation-and-tuning` and `training-optimization`. The title says post-training and the body decomposes the update into on- and off-manifold components; neither subject was named (ADR-tmphn2vp).
tags:
