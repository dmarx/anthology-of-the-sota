...
# LIT-178: Nemotron-CC: Transforming Common Crawl into a Refined Long-Horizon Pretraining Dataset
...
The other side of the filtering trade-off from [LIT-184](LIT-184.md), and the pair is
...
high-quality if you filter less; and [LIT-166](LIT-166.md) prices repetition against
