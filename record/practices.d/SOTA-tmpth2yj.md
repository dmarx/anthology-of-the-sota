...
# SOTA-tmpth2yj: Leave the inner optimizer state unsynchronised in local-update training
...
**It reproduces outside the lab that published it.** [LIT-tmp323u1](../literature.d/LIT-tmp323u1.md) is an
...
([LIT-tmpz7s7p](../literature.d/LIT-tmpz7s7p.md)) wraps a base optimizer in outer momentum four years earlier and
