...
# LIT-182: Qwen3 Technical Report
...
series is named after. It is also what GSPO ([LIT-180](LIT-180.md)) is credited with
improving.
...
designs it carries. Its value here is as the dense baseline the Qwen hybrids are measured against, which is a role notes fill and practices do not.
