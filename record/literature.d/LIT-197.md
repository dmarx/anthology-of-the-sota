...
<!-- inactive-ok-block: SOTA-160 — Proposed, named as the other half of
     the same decision -->
**The practice is [SOTA-163](../practices.d/SOTA-163.md), `Active`.** It carries the regime table —
...
[SOTA-160](../practices.d/SOTA-160.md) is the other half, on where in the pipeline the low precision
can sit.
