...
---
# NOTE-tmprv9sv: Exact Solution for On-Line Learning in Multilayer Neural Networks
...
- Goldt et al. 2020 ([LIT-tmpst0ap](../literature.d/LIT-tmpst0ap.md)) — Extends S-curve analysis to ReLU and
