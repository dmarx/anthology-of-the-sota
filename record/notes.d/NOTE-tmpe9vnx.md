...
---
# NOTE-tmpe9vnx: Git Re-Basin: Merging Models modulo Permutation Symmetries
...
- The Role of Permutation Invariance in Linear Mode Connectivity of Neural
  Networks ([LIT-tmp2m8yx](../literature.d/LIT-tmp2m8yx.md)) — Entezari et al. prove the theoretical guarantee;
  this paper provides the practical algorithms to find the permutation.

**Related.**

- Entezari et al. 2022 ([LIT-tmp2m8yx](../literature.d/LIT-tmp2m8yx.md)) — Theoretical foundation for why
