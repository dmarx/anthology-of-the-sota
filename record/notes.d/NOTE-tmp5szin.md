...
---
# NOTE-tmp5szin: Distributed Deep Learning in Open Collaborations
...
- Towards Crowdsourced Training of Large Neural Networks using Decentralized
  Mixture-of-Experts ([LIT-tmp1lc2w](../literature.d/LIT-tmp1lc2w.md)) — DeDLOC uses the Hivemind library
...
- SWARM Parallelism: Training Large Models Can Be Surprisingly
  Communication-Efficient ([LIT-tmpi6utz](../literature.d/LIT-tmpi6utz.md)) — SWARM builds on DeDLOC's
...
- OpenDiLoCo: An Open-Source Framework for Globally Distributed Low-
  Communication Training ([LIT-tmp323u1](../literature.d/LIT-tmp323u1.md)) — OpenDiLoCo uses Hivemind (from
