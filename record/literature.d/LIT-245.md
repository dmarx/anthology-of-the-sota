...
---
# LIT-245: Bayesian Learning via Stochastic Gradient Langevin Dynamics
...
Read — the reading is [NOTE-123](../notes.d/NOTE-123.md). Arrived in the imported batch, which
