...
---
# LIT-tmptm9xf: Generalized EXTRA stochastic gradient Langevin dynamics
...
Read — the reading is [NOTE-tmpqvvkl](../notes.d/NOTE-tmpqvvkl.md). Arrived in the imported batch, which
