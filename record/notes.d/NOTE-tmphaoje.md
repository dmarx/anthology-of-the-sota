...
---
# NOTE-tmphaoje: On-line learning in soft committee machines
...
- Goldt et al. 2020 — hidden manifold model ([LIT-tmpst0ap](../literature.d/LIT-tmpst0ap.md)) — Modern
...
- Refinetti et al. 2021 ([LIT-tmpxoox8](../literature.d/LIT-tmpxoox8.md)) — Applies same ODE methods to
