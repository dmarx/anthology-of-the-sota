...
# LIT-381: Scaling Diffusion Language Models via Adaptation from Autoregressive Models

<!-- inactive-ok-file: SOTA-157 — Proposed, and named as the OTHER branch of this same decision; the pairing is the content -->
<!-- inactive-ok-file: SOTA-232 — Proposed, and filed in this same contribution as the practice this note sources -->
...
Sources [SOTA-232](../practices.d/SOTA-232.md), and pairs with something the record already
