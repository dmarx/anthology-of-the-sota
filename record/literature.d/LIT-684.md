...
<!-- inactive-ok-file: SOTA-415 SOTA-156 SOTA-288 — all Proposed; the practice this
     paper sources, and two neighbours it is placed against without being
     relied on by either -->

# LIT-684: Model Merging in Pre-training of Large Language Models
...
narrow practice, `SOTA-415`: estimate the annealed score from a
