...
---
# NOTE-115: 1-bit Adam: Communication Efficient Large-Scale Training with Adam's Convergence Speed
...
- PowerSGD: Practical Low-Rank Gradient Compression for Distributed
  Optimization ([LIT-337](../literature.d/LIT-337.md)) — PowerSGD is cited as a state-of-the-art
