...
- version: 2
  ...
  note: >-
    ...
    document is a property of the data: it separates two accounts of why
    small models cannot produce coherent English, the complexity of language
    and the breadth of the corpus, and finds it is breadth.
tags:
- tiny-models
- data-pipeline
