...
**6 documents cited without acknowledgement.** Not listed: 138 citations someone has already vouched for with an `inactive-ok:` comment at the citing site.
...
2 citations in 1 file await a look; 14 other citations of it are acknowledged.
