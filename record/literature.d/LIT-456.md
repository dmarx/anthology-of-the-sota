...
<!-- inactive-ok-file: THEORY-024 THEORY-033 ADR-031 — THEORY-024 is Proposed as of this contribution and is the account this paper tests; THEORY-033 is Proposed and filed here from this paper; ADR-031 is Proposed and is the decision that makes the practice/explanation split this note relies on -->
# LIT-456: Muon is Not That Special: Random or Inverted Spectra Work Just as Well
...
being the duality map is *why* it works. See [THEORY-033](../theory.d/THEORY-033.md).
