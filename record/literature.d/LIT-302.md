...
summary: >-
  ...
  latency networks.
---
# LIT-302: Can Decentralized Algorithms Outperform Centralized Algorithms? A Case Study for Decentralized Parallel Stochastic Gradient Descent
...
Read — the reading is [NOTE-100](../notes.d/NOTE-100.md). Arrived in the imported batch, which
