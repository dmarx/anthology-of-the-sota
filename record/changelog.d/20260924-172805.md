...
- **DMD** (`LIT-tmp8mirn`, 2311.18828) and **DMD2** (`LIT-tmpcjcg4`,
...
- **Building Normalizing Flows with Stochastic Interpolants**
  (`LIT-tmp90ynr`, 2209.15571) and **Stochastic Interpolants: A Unifying
  Framework** (`LIT-tmpb08v0`, 2303.08797). The second is the framework SiT
  instantiates, and SiT now `extends` it.
- **Improving Image Generation with Better Captions** (`LIT-tmpu3jdj`, the
  DALL-E 3 paper; OpenAI PDF, no arXiv id). Its controlled evidence is CLIP
  score only.
- **Scheduled Sampling** (`LIT-tmpylvlq`, 1506.03099), **MIXER**
  (`LIT-tmpnp0ky`, 1511.06732) and **Professor Forcing** (`LIT-tmp6j622`,
