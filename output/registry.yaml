...
recommendations:
  standard:
    ...
    - id: MLR-2017-Micikevicius001-0001
      recommendation: Use dynamic loss scaling that doubles every 2000 successful
        steps
    ...
    - id: MLR-2015-Ioffe001-0001
      recommendation: Place BatchNorm after linear/conv layers but before activation
        functions
      topic: normalization
    ...
    - id: MLR-2019-Dao001-0001
      recommendation: Use multi-query attention for decoder-only models to reduce
        memory bandwidth
      topic: transformers
    ...
    - id: MLR-2020-Rajbhandari001-0002
      recommendation: Partition gradients and optimizer states (ZeRO-2) for larger
        models
      topic: memory-efficiency
    ...
    - id: MLR-2022-Hoffmann001-0002
      recommendation: Optimal batch size scales approximately with compute budget
        - `B ∝ C^(1/4)`
      topic: scaling-laws
    ...
    - id: MLR-2022-Dao002-0003
      recommendation: Recompute attention during backward pass instead of storing
        it
      topic: attention
    ...
    - id: MLR-2023-Dao003-0003
      recommendation: Pad attention masks to block boundaries for better hardware
        utilization
      topic: attention
    ...
    - id: MLR-2017-You001-0001
      recommendation: linear warmup of LR stabilizes early training with large batch
        size.
    ...
    - id: MLR-2017-Li001-0001
      recommendation: skip connections promote training stability by smoothing out
        the loss landscape
      topic: optimization
    ...
    - id: MLR-2022-Chowdhery001-0001
      recommendation: smaller batch sizes are more sample efficient (i.e., better
        loss as a function of tokens seen) earlier in training
      topic: language-models
    ...
    - id: MLR-2022-Chowdhery001-0004
      recommendation: consider rewinding to earlier checkpoint and skipping a few
        batches to mitigate unusual loss spikes
      topic: language-models
