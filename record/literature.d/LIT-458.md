...
- version: 2
  date: '2026-09-23'
  note: >-
    The antecedent it said was missing is filed (LIT-606), and the
...
something absent. It is now [LIT-606](LIT-606.md), and its account is
[THEORY-090](../theory.d/THEORY-090.md). This paper's convergence claim is also filed under
`concept-geometry` ([ADR-060](../decisions.d/ADR-060.md)): whether different models arrive at the
