...
- version: 2
  date: '2026-09-23'
  note: >-
    The antecedent it said was missing is filed (LIT-tmpoa14o), and the
    paragraph saying so is rewritten. Adds `concept-geometry` as a secondary
    topic.
tags:
...
# LIT-458: The Platonic Representation Hypothesis
<!-- inactive-ok-file: THEORY-036 — Proposed, and filed in this same contribution from this note -->
...
It sources [THEORY-036](../theory.d/THEORY-036.md) and one practice. The practice is the part most
...
**The antecedent is now filed.** Both this and [LIT-460](LIT-460.md) build on
the Linear Representation Hypothesis — that features and concepts are
directions in embedding space. When this was filed the record had no document
for it, and this paragraph called it a trunk found by two papers standing on
something absent. It is now [LIT-tmpoa14o](LIT-tmpoa14o.md), and its account is
[THEORY-tmpsbx36](../theory.d/THEORY-tmpsbx36.md). This paper's convergence claim is also filed under
`concept-geometry` ([ADR-tmpw9gmq](../decisions.d/ADR-tmpw9gmq.md)): whether different models arrive at the
same geometry is part of that topic.
