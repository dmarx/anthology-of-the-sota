...
| 2026-09-09 | Proposed | [SOTA-190](../../record/practices.d/SOTA-190.md) | 14 | 0 | Increase depth before any other dimension when scaling a transformer |
...
| 2026-09-25 | Proposed | [SOTA-430](../../record/practices.d/SOTA-430.md) | 25 | 0 | Before using an attribution map to debug a model or explain what it learned, check that the map changes when the weights are randomized and when the labels are permuted — do not validate it by how it looks |
...
| 2026-09-23 | Proposed | [THEORY-090](../../record/theory.d/THEORY-090.md) | 11 | 0 | A concept's shared word-pair direction, its linear probe and its steering vector are one object, related by an inner product under which causally separable concepts are orthogonal |
...
| 2026-09-26 | Proposed | [THEORY-113](../../record/theory.d/THEORY-113.md) | 11 | 0 | A gradient attribution survives weight randomization because of its input multiplier, not because the attribution is insensitive to the weights |
