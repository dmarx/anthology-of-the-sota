...
summary: >-
  ...
  settings.
---
# NOTE-tmpwigvz: Stochastic Gradient Push for Distributed Deep Learning
...
- Can Decentralized Algorithms Outperform Centralized Algorithms? A Case
  Study for Decentralized Parallel SGD ([LIT-tmphrzo0](../literature.d/LIT-tmphrzo0.md)) — Generalizes D-PSGD
