...
<!-- inactive-ok-block: SOTA-168 — the practice drawn from this paper,
     Proposed, and saying why is what this paragraph does -->
Two practices rest on it, and the split is the point. [SOTA-168](../practices.d/SOTA-168.md) is SOAP
itself, `Proposed`: the record recommends Muon ([SOTA-121](../practices.d/SOTA-121.md)) on production
evidence at trillion-parameter scale that SOAP does not have. [SOTA-165](../practices.d/SOTA-165.md)
