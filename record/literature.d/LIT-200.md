...
- version: 2
  date: '2026-09-18'
  note: >-
    Adds `model-architecture`. PowLU is an activation function, which is an architectural component whatever motivated it — stability, here.
tags:
- model-stability
- model-architecture
...
<!-- inactive-ok-block: SOTA-158 — the practice drawn from this paper,
     Proposed, and saying why is what this paragraph does -->
**The practice is [SOTA-158](../practices.d/SOTA-158.md), `Proposed`** — and it is the *trunk*, not
PowLU. What this paper and Kimi K3 agree on is that an unbounded activation
is a numerical liability once the arithmetic narrows; the functions they chose
differ and nobody has compared them. Filing the constraint separately lets a
reader act on the agreement without picking a side of the disagreement, which
is the same move the record made for the hyper-connections trunk.
