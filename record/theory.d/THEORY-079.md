...
- LIT-553
summary: >-
  Bansal et al. (2022), [LIT-553](../literature.d/LIT-553.md) — the account cold diffusion was named
...
<!-- inactive-ok-file: THEORY-080 — Proposed, filed in this same contribution as the account that replaces this one -->

# THEORY-079: What makes a diffusion model generative is iterated restoration of any degradation, not Gaussian noise
...
**The sweep that went looking.** Warm Diffusion ([LIT-555](../literature.d/LIT-555.md)) holds the
...
severity ([LIT-553](../literature.d/LIT-553.md), §3.3). Neither needs this account. The replacement
explanation is [THEORY-080](THEORY-080.md).
