...
<!-- inactive-ok-file: THEORY-108 — Proposed; named as the account this paper corroborates -->
...
- **It reconciles Kaplan's *adjusted* exponent.** Kaplan's raw fit is 0.88. The
  larger replication, Porian et al. 2024 ([LIT-690](LIT-690.md)), attributes the gap
...
**Porian et al. is now filed** ([LIT-690](LIT-690.md)) and is the primary source of
[THEORY-108](../theory.d/THEORY-108.md). This paper is its corroborating source.
