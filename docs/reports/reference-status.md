...
**7 documents cited without acknowledgement.** Not listed: 574 citations someone has already vouched for with an `inactive-ok:` comment at the citing site.
...
2 citations in 1 file await a look; 21 other citations of it are acknowledged.
...
### ADR-089 — resolves to nothing (1 unmarked site)

- [`record/decisions.d/ADR-038.md:108`](../../record/decisions.d/ADR-038.md)
