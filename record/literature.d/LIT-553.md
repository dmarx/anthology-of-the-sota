...
# LIT-553: Cold Diffusion: Inverting Arbitrary Image Transforms Without Noise
...
as [THEORY-079](../theory.d/THEORY-079.md) and is `Rejected` on the paper's own numbers and on Warm
Diffusion's sweep ([LIT-555](LIT-555.md)). The corrected account is [THEORY-080](../theory.d/THEORY-080.md).
...
Read — [NOTE-299](../notes.d/NOTE-299.md).
