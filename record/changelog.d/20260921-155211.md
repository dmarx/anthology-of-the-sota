...
- **`LIT-tmpobm1s`** — Mixture-of-Transformers (Liang et al., 2024). Untie
  ...
  and a 760M model beating a 1.4B dense one. Read as `NOTE-tmpl9zt7`.
- **`THEORY-tmpgsr9o`** — modalities compete for the same feed-forward
