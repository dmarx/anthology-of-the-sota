...
- **Improved Precision and Recall Metric for Assessing Generative Models** —
  `LIT-tmptzz06`. Kynkäänniemi, Karras, Laine, Lehtinen and Aila (2019),
...
- **`THEORY-tmpv11wm`**, `Proposed` — FID is not neutral between fidelity and
...
named in `LIT-tmptzz06`'s Standing section rather than left implicit.
