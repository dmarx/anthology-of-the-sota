...
- version: 2
  date: '2026-09-10'
  note: >-
    Records that ADR-tmpdrbma removed the mechanism this principle warns
...
[ADR-tmpdrbma](../record/decisions.d/ADR-tmpdrbma.md) — superseding [ADR-020](../record/decisions.d/ADR-020.md), whose decision it carries forward —
...
`ADR-tmpdrbma` went further than the repair above and gave the practice
...
bent to fit a document somebody wanted in. `ADR-tmpdrbma` makes the decision in
