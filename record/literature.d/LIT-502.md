...
# LIT-502: MemGraphRAG: Memory-based Multi-Agent System for Graph Retrieval-Augmented Generation

Wu, Xiang, Tang, Chen, Zhang and Su (2026) —
[ARXIV-2606.00610](https://arxiv.org/abs/2606.00610), read as [NOTE-249](../notes.d/NOTE-249.md).
KDD 2026.
...
Filed for [SOTA-308](../practices.d/SOTA-308.md), which rests on the pilot study.
