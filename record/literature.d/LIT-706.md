...
<!-- inactive-ok-file: SOTA-429 — Proposed practice this paper sources, named in its standing as what it produced -->
# LIT-706: Scaling Language-Image Pre-training via Masking

Li, Fan, Hu, Feichtenhofer and He (2022) — [ARXIV-2212.00794](https://arxiv.org/abs/2212.00794) (CVPR 2023).
Read in full as [NOTE-371](../notes.d/NOTE-371.md).
...
It sources [SOTA-429](../practices.d/SOTA-429.md), `Proposed`, which extends both. The practice is
