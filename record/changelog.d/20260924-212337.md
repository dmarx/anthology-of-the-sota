...
- **Intriguing Properties of Quantization at Scale** — `LIT-tmp7791d`.
...
- **`THEORY-tmp3s87v`**, `Proposed` — activation outliers are a product of
...
- **`SOTA-tmpqmou6`**, `Proposed`/`unreplicated` — choose weight decay,
