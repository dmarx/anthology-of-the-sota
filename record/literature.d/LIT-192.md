...
arxiv: '2306.15595'
# The paper's own first sentence: it extends the context window of
# "RoPE-based pretrained LLMs". The method is a rescaling of RoPE's position
# indices and has no meaning without it.
extends:
- LIT-045
first_author: 'Chen'
keywords:
