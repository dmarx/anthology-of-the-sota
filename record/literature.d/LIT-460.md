...
- version: 2
  date: '2026-09-23'
  note: >-
    The antecedent it said was missing is filed (LIT-606), and this
    paper extends it. Takes `concept-geometry` as primary (ADR-060); the
...
why `concept-geometry` exists ([ADR-060](../decisions.d/ADR-060.md)), and this paper now takes it as
its primary topic.
...
[LIT-606](LIT-606.md), which this paper `extends`. Its account is [THEORY-090](../theory.d/THEORY-090.md), and
