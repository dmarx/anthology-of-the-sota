...
<!-- inactive-ok-file: ADR-020 — Superseded by ADR-tmpdrbma. Cited here as the reasoning that stood when this decision was made; a filed decision records its own moment (DP-003) -->
