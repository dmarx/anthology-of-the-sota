...
date: '2026-09-15'
source:
# LIT-257 is primary: it gives the aggregator that needs no estimate of
...
# SOTA-220: Aggregate worker gradients coordinate-wise by median when any worker may be faulty
...
**It interacts badly with compression.** [SOTA-214](SOTA-214.md) keeps a local residual
