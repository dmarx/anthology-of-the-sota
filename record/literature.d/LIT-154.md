...
**No practice of its own, and the reason is altitude rather than adoption.**
The stability recipe is the most completely documented account in the corpus
of what keeps a mid-scale run alive, and it is a *recipe*: a bundle of
interventions reported together, with the released checkpoints that would let
someone take it apart. Nobody has. Until somebody isolates which intervention
does what, filing it would recommend a bundle on the authority of its
outcome, which is the failure [ADR-017](../decisions.d/ADR-017.md) is about.

Its annealing result is a different matter and is not orphaned: it reaches
the observation [SOTA-140](../practices.d/SOTA-140.md) rests on from a data-mixture direction rather than a
schedule-shape one, and is worth reading beside it.
