...
# LIT-584: Accurate structure prediction of biomolecular interactions with AlphaFold 3
...
**Filed from `#163`** ("AlphaFold"). It `extends` AlphaFold 2 ([LIT-583](LIT-583.md)).
It sources [SOTA-352](../practices.d/SOTA-352.md) (cross-distillation against hallucination) and is
a second source for [SOTA-353](../practices.d/SOTA-353.md) (confidence-ranked sampling).
...
Read — [NOTE-320](../notes.d/NOTE-320.md).
<!-- inactive-ok-file: SOTA-352, SOTA-353 — Proposed, filed in this same contribution with this paper as a source -->
