...
# LIT-219: PyTorch Distributed: Experiences on Accelerating Data Parallel Training
...
- Bucketing is the same problem Horovod's Tensor Fusion ([LIT-220](LIT-220.md))
...
Filed alongside [LIT-220](LIT-220.md) for the same reason: the practices were right and
