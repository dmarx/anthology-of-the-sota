...
---
# LIT-294: On-line learning in soft committee machines

Saad and Solla (1995) — [DOI:10.1103/PhysRevE.52.4225](https://doi.org/10.1103/PhysRevE.52.4225)

## What it is

The exact learning dynamics of a soft committee machine under online
gradient descent, including the symmetric plateau and the specialization
that ends it.
