...
---
# NOTE-tmpnnrhg: Coordination of groups of mobile autonomous agents using nearest neighbor rules
...
- D-PSGD (Can Decentralized Algorithms Outperform Centralized Algorithms?)
  ([LIT-tmphrzo0](../literature.d/LIT-tmphrzo0.md)) — D-PSGD's mixing condition (spectral gap ρ < 1 on a fixed
