...
---
# NOTE-tmp5xv87: Can Decentralized Algorithms Outperform Centralized Algorithms? A Case Study for Decentralized Parallel Stochastic Gradient Descent
...
- EASGD ([LIT-tmpyt7pc](../literature.d/LIT-tmpyt7pc.md)) — Compared empirically; D-PSGD outperforms on Gigabit
  Ethernet because EASGD still routes through a center variable.

**Related.**

- Stochastic Gradient Push (SGP) ([LIT-tmp3gm3p](../literature.d/LIT-tmp3gm3p.md)) — Extends D-PSGD to directed
  graphs using push-sum gossip.
- Cooperative SGD ([LIT-tmpf4zv3](../literature.d/LIT-tmpf4zv3.md)) — Subsumes D-PSGD in a unified framework
  A(tau, W, v) and provides the first non-convex proof for EASGD.
- Epidemic Learning ([LIT-tmpl3bu5](../literature.d/LIT-tmpl3bu5.md)) — Uses D-PSGD-style averaging as
