...
<!-- inactive-ok-file: SOTA-226, SOTA-222 — Proposed practices,
...
# ADR-041: An algorithm-local tuning constant belongs in the reading of the paper that measured it, not in the practice registry
...
**A practice may still cite the constant in prose.** [SOTA-226](../practices.d/SOTA-226.md) names
[LIT-254](../literature.d/LIT-254.md)'s 30-epoch densification schedule and declines it; [SOTA-222](../practices.d/SOTA-222.md) names
...
**A threshold about the world is not a tuning constant.** [SOTA-225](../practices.d/SOTA-225.md)
