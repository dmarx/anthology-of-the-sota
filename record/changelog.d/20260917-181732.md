...
- `ADR-tmpi1wo9` (`Proposed`) — doubt about whether an item is worth carrying
...
- `SOTA-tmp4fwxw` (`Proposed`) — select pretraining data by matching a target
...
- `SOTA-tmp2nprq` (`Proposed`) — rank candidate data selections with a
