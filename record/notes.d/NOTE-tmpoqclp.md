...
summary: >-
  ...
  gap.
---
# NOTE-tmpoqclp: Convex Analysis of the Mean Field Langevin Dynamics
...
- On the Global Convergence of Gradient Descent for Over-parameterized
  Models using Optimal Transport ([LIT-tmpge342](../literature.d/LIT-tmpge342.md)) — Part of the mean field
