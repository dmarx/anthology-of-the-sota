...
- version: 2
  ...
  note: >-
    ...
    (2019) §5.2, now carried in `introduced_by:` under ADR-tmpqczy4. The
...
# older and the body was naming it without a citation (ADR-tmpqczy4).
introduced_by:
- LIT-tmpt0oos
summary: >-
...
That factor has an author. Child et al. (2019), [LIT-tmpt0oos](../literature.d/LIT-tmpt0oos.md) §5.2, scales the
...
[ADR-tmpqczy4](../decisions.d/ADR-tmpqczy4.md) gave the record a field for it.
