...
**5 documents cited without acknowledgement.** Not listed: 1547 citations someone has already vouched for with an `inactive-ok:` comment at the citing site.
...
**1 code not minted here.** Not listed: 3 mentions marked deliberate with an `unresolved-ok:` comment — an illustrative code in an example is the usual one.


### THEORY-tmp3s87v — not minted here (2 unmarked sites)

- [`record/literature.d/LIT-662.md:140`](../../record/literature.d/LIT-662.md)
- [`record/theory.d/THEORY-101.md:106`](../../record/theory.d/THEORY-101.md)
...
- record/literature.d/LIT-662.md:34: annotation no longer applies — nothing in scope cites THEORY-100
- record/theory.d/THEORY-101.md:25: annotation no longer applies — nothing in scope cites THEORY-100
