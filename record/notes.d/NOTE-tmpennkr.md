...
---
# NOTE-tmpennkr: Don't Use Large Mini-Batches, Use Local SGD
...
- Local SGD Converges Fast and Communicates Little ([LIT-tmpx82es](../literature.d/LIT-tmpx82es.md)) — Provides
...
- SlowMo: Improving Communication-Efficient Distributed SGD with Slow
  Momentum ([LIT-tmpz7s7p](../literature.d/LIT-tmpz7s7p.md)) — SlowMo cites post-local SGD and generalizes the
