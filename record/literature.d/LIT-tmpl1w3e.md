...
---
# LIT-tmpl1w3e: Proving the Limited Scalability of Centralized Distributed Optimization via a New Lower Bound Construction
...
Read — the reading is [NOTE-tmp8mk48](../notes.d/NOTE-tmp8mk48.md). Arrived in the imported batch, which
