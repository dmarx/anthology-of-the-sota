...
---
# NOTE-tmp551iv: Asynchronous Stochastic Gradient Descent with Delay Compensation
...
- Hogwild!: A Lock-Free Approach to Parallelizing Stochastic Gradient
  Descent ([LIT-tmpatkfs](../literature.d/LIT-tmpatkfs.md)) — Adopts the asynchronous parameter-server
...
- Asynchronous stochastic gradient descent with decoupled backpropagation
  and layer-wise updates ([LIT-tmpzenzq](../literature.d/LIT-tmpzenzq.md)) — Cites DC-ASGD as a prior delay-
