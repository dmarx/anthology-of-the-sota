...
<!-- inactive-ok-file: THEORY-024 — Proposed since the Kaon control (LIT-456); this section exists to contrast the two accounts, and a contrast with an account in doubt is still a contrast (ADR-010) -->
