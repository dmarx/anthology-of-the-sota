...
- **Classifier-Free Diffusion Guidance** — `LIT-tmpy02tv`. Ho and Salimans (2022),
...
- **`SOTA-tmpfci2h`**, `Active`/`universal` — the recipe, and the rule for
...
- **`THEORY-tmpkf09c`**, `Proposed` — classifier guidance may flatter
